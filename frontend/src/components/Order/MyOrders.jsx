...
const MyOrders = () => {
    ...
    useEffect(() => {
        ...
        if (status) {
            filteredArr = filteredArr.filter((order) => order.orderStatus === status);
        }

        if (+orderTime === dt.getMonth()) {
            filteredArr = filteredArr.filter((order) => new Date(order.createdAt).getMonth() === +orderTime);
        } else if (orderTime) {
            filteredArr = filteredArr.filter((order) => new Date(order.createdAt).getFullYear() === +orderTime);
        }
