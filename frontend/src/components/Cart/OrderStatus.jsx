...
const OrderStatus = () => {
    ...
    // Define shipping cost based on some condition
    const shippingCost = baseTotalPrice > 3000000 ? 0 : 15000;  // Free shipping for orders over 3,000,000 VND
    ...
    const orderData = {
        ...
        totalPrice,  // Updated total price including shipping
    }
